...
export default function AllConnectionModel({ ActiveTab, user, currentUserId }) {
  ...
  const handleChatOpen = (connection) => {
    setSelectedChatUser([connection]); // Chat component expects an array
    setChatOpen(true);
  };
                  ...
                  <div key={connection._id} className={styles.connectionCard}>
                    ...
                    <div className={styles.connectionActions}>
                      <button
                        ...
                        onClick={() => handleChatOpen(connection)}
                      >
                        💬 Chat
                      </button>
                      <button
